...
def hf_download(repo_id: Optional[str] = None, hf_token: Optional[str] = None) -> None:
    ...
    try:
        snapshot_download(repo_id, local_dir=f"checkpoints/{repo_id}", cache_dir = "/work/zhang-capra/users/ky427/huggingface_cache", local_dir_use_symlinks='auto', token=hf_token)
